...
<div class="container">
        ...
        <div class="col-md-4">
            ...
            <select name="idcampeonato" class="form-control" onchange="this.form.submit()">
                @foreach($campeonatos as $camp)
                    <option value="{{ $camp->idcampeonato }}" {{ $camp->idcampeonato == $idcampeonato ? 'selected' : '' }}>
    ...
    <a href="{{ route('campeonatos.generarCuartos', $idcampeonato) }}" class="btn btn-sm btn-outline-primary mb-3">
    Generar Cuartos de Final
</a>
<a href="{{ route('campeonatos.generarEliminatorias', $idcampeonato) }}" class="btn btn-sm btn-outline-danger mb-3">
    Generar Semifinales y Final
</a>
<a href="{{ route('campeonatos.asignarFinalistas', $idcampeonato) }}" class="btn btn-sm btn-outline-success mb-3">
    Asignar Finalistas
</a>
</form>
